...
public class UnsafeList {
	...
	long sum(List<? extends Number> numbers) {
		long sum=0;
		for (Number n:numbers) {
			sum += n.longValue();
		}
...
//		Solution: overload method sum which instead of using T, uses wildcard ? extends T
//		          refer to overloaded method (lines 17 - 23 )
