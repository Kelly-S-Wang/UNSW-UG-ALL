create or replace function insertFlightTrigger() returns trigger
as $$
declare
	ns integer;
begin
...
create or replace function insertBookingTrigger() returns trigger
as $$
declare
	avail integer;
begin
...
create or replace function deleteBookingTrigger() returns trigger
as $$
begin
	update Flights 
	set seatsAvail = seatsAvail + 1
	where id = old.flight;
	return new;
end;
$$ language plpgsql;
